const pieData = [
  {name: '台北', value: 15, color: '#0FCBE3'},
  {name: '台中', value: 6, color: '#7254FF'},
  {name: '高雄', value: 7, color: '#0CBF7E'},
  {name: '工廠', value: 7, color: '#F4B41E'},
  {name: '未出席', value: 7, color: '#DDDDDD'},
];

// 拿取csv資料
const getpieData = async ()=>{
  const pieData = await d3.csv('Deta/corp.csv')
  console.log('pieData',pieData)
};
getpieData()
var color = d3.scaleOrdinal([ "#7b6888", "#6b486b", "#a05d56", "#d0743c", "#ff8c00"]);
